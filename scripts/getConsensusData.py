...
# default ports
REST = "https://rest.arable.stakepool.dev.br/"
RPC = "https://rpc.arable.stakepool.dev.br/"
...
def get_validator_votes():
    ...
    result_list = [validator_votes, height, step, r_ound['round']]
    return result_list
...
def merge_info():
    ...
    votes_and_vals = list(zip(votes[0], validators))
...
def main(STATE):
    ...
    result = get_validator_votes()

    data = {
        'online_validators': online_vals, 
    ...
    # responseInJson = jsonify(data)
    with open('./collectedData/consensus.json', 'w') as json_file:
